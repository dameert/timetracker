 ...
 */
final class Version20210218213133 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE time_slot (id INT NOT NULL, task_id INT NOT NULL, work_day_id INT NOT NULL, time_interval VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('COMMENT ON COLUMN time_slot.time_interval IS \'(DC2Type:dateinterval)\'');
        $this->addSql('CREATE TABLE work_day (id INT NOT NULL, PRIMARY KEY(id))');
